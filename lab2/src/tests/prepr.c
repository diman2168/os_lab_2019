...
# 5 "tests.c" 2
# 1 "../revert_string/revert_string.h" 1
...
void testRevertString(void) {
  ...
  ((0 == strcmp(simple_string, "olleH")) ? (void) (0) : __assert_fail ("0 == strcmp(simple_string, \"olleH\")", "tests.c", 14, __PRETTY_FUNCTION__));

  RevertString(str_with_spaces);
  ((0 == strcmp(str_with_spaces, "secaps htiw gnirtS")) ? (void) (0) : __assert_fail ("0 == strcmp(str_with_spaces, \"secaps htiw gnirtS\")", "tests.c", 17, __PRETTY_FUNCTION__));

  RevertString(str_with_odd_chars_num);
  ((0 == strcmp(str_with_odd_chars_num, "cba")) ? (void) (0) : __assert_fail ("0 == strcmp(str_with_odd_chars_num, \"cba\")", "tests.c", 20, __PRETTY_FUNCTION__));

  RevertString(str_with_even_chars_num);
  ((0 == strcmp(str_with_even_chars_num, "dcba")) ? (void) (0) : __assert_fail ("0 == strcmp(str_with_even_chars_num, \"dcba\")", "tests.c", 23, __PRETTY_FUNCTION__));
}
